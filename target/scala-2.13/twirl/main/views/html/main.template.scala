...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen" href=""""),_display_(/*14.54*/assetsFinder/*14.66*/.path("../../public/stylesheets/style.css")),format.raw/*14.109*/("""">
        <link rel="shortcut icon" type="image/png" href=""""),_display_(/*15.59*/assetsFinder/*15.71*/.path("images/favicon.png")),format.raw/*15.98*/("""">
        <script src=""""),_display_(/*16.23*/assetsFinder/*16.35*/.path("../../public/javascripts/custom.js")),format.raw/*16.78*/("""" type="text/javascript"></script>
    </head>
    <body>
        """),format.raw/*20.32*/("""
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: 9c8369cfdcdfb91c23ceac874c71af7615c95e98
                  MATRIX: 1178->260|1339->328|1366->329|1446->434|1482->443|1517->451|1543->456|1632->518|1653->530|1718->573|1806->634|1827->646|1875->673|1927->698|1948->710|2012->753|2106->909|2143->919|2171->926|2203->931
